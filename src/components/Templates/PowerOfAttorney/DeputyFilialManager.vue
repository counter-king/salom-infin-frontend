...
<template>
  <div class="deputy-filial-manager-poa letter-template">
    ...
    <div class="text-justify indent-8 text-sm">
      ...
      <div>
        {{ route.params.document_sub_type === COMPOSE_DOCUMENT_SUB_TYPES.POA_BSO_DEPUTY_MANAGER_BUSINESS ? 'Ofis' : 'Markaz' }} tomonidan Bank nomidan belgilangan tartibda kichik va o‘rta biznes mijozlariga xizmatlarni ko‘rsatishda,
        jumladan bank hisobvarag‘i, omonat, kredit, garov (ipoteka), kafolat, kafillik shartnomalarini imzolash,

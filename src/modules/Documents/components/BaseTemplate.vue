...
const formMap = {
  ...{
    ...
    [COMPOSE_DOCUMENT_SUB_TYPES.BUSINESS_TRIP_NOTICE_FOREIGN]: MultipleTemplates
  },
  APPLICATION: [
  ...
  POA: [
    ...
    COMPOSE_DOCUMENT_SUB_TYPES.POA_RETURN_ENFORCEMENT_DOCUMENT,
    COMPOSE_DOCUMENT_SUB_TYPES.POA_MEDIATION_AGREEMENT,
  ]
}

...
<template>
 <div
   ...
   >
   <span class="text-sm font-medium text-greyscale-500">{{props.progress + 1}}%</span>
   <div class="w-full h-1 bg-greyscale-100 rounded-lg">
    <div 
      class="h-1 bg-success-500 rounded-lg"
      :class="`w-[${props.progress + 1}%]`"
     ></div>
   </div>

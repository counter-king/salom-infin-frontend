...
const series = computed(() => {
  const values = Object.values(dashboardStore.expenseChart.data)
...
onMounted(async () => {
  await dashboardStore.actionTripExpenseChart()
})
</script>
...
<!--      </div>-->
    ...
    <template v-if="dashboardStore.expenseChart.loader">
      <div class="h-[275px]">
        <base-spinner />
      </div>
    </template>

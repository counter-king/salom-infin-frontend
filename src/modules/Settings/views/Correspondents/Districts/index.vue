...
const getDistricts = (newFilter = {}) => {
  ...
  axiosConfig
    ...
    .then(response => {
      ...
      const newDistricts = Array.isArray(results) ? results: [];
      districts.value = newDistricts;
...
const getFirstPageDistricts = () => {
  getDistricts(defaultFilter);
};
...
<style>
.districts-table th:first-child, td:first-child {
  border-radius: 12px 0 0 12px;
}
.districts-table th:last-child, td:last-child {
